...
function AMT:Framework()
	...
	self.Window.Tracker:SetSize(self.Window:GetWidth(), self.Window:GetHeight())
	...
	if Details then
		...
		for i = 1, 5 do
			...
			PartyKeystone_Rightext:SetPoint("TOPRIGHT", self.Window.Tracker.PartyKeys, "TOPRIGHT", -6, yOffset * i - 2)
			...
			PartyKeystone_Lefttext:SetPoint("TOPLEFT", self.Window.Tracker.PartyKeys, "TOPLEFT", 6, yOffset * i)
	...
	for i = 1, 4 do
		...
		if i == 1 then
			...
			self.Window.Tracker.Graph.dividers[i]:SetStartPoint("TOPLEFT", xOffset, YPos_Start)
			self.Window.Tracker.Graph.dividers[i]:SetEndPoint("BOTTOMLEFT", xOffset, YPos_End)
		elseif i == 2 then
			-- x = 186
	...
	self.Window.Info:SetSize(self.Window:GetWidth(), self.Window:GetHeight())
