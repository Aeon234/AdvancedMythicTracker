...
AMT.SeasonalInfo.DungeonTable = {
	...
	content = {
		...
		[2] = {
			{ text = 619, color = { 0.5, 0.5, 0.5, 1 } },
			{ text = 636, color = AMT.Rare_Color },
			{ text = 639, color = AMT.Rare_Color },
			{ text = 639, color = AMT.Rare_Color },
			{ text = 642, color = AMT.Rare_Color },
			{ text = 645, color = AMT.Rare_Color },
			{ text = 649, color = AMT.Epic_Color },
			{ text = 649, color = AMT.Epic_Color },
			{ text = 652, color = AMT.Epic_Color },
			{ text = 652, color = AMT.Epic_Color },
			{ text = 655, color = AMT.Epic_Color },
			{ text = 655, color = AMT.Epic_Color },
			{ text = 655, color = AMT.Epic_Color },
		},
		[3] = {
			{ text = 632, color = AMT.Uncommon_Color },
			{ text = 645, color = AMT.Rare_Color },
			{ text = 649, color = AMT.Epic_Color },
			{ text = 649, color = AMT.Epic_Color },
			{ text = 652, color = AMT.Epic_Color },
			{ text = 652, color = AMT.Epic_Color },
			{ text = 655, color = AMT.Epic_Color },
			{ text = 658, color = AMT.Epic_Color },
			{ text = 658, color = AMT.Epic_Color },
			{ text = 658, color = AMT.Epic_Color },
			{ text = 662, color = AMT.Legendary_Color },
			{ text = 662, color = AMT.Legendary_Color },
			{ text = 662, color = AMT.Legendary_Color },
		},
		[4] = {
...
AMT.SeasonalInfo.RaidDropsTable = {
	...
	content = {
		[1] = {
			{ text = "1", color = AMT.BackgroundClear_Table },
			{ text = "2, 3", color = AMT.BackgroundClear_Table },
			{ text = "4, 5, 6", color = AMT.BackgroundClear_Table },
			{ text = "7, 8", color = AMT.BackgroundClear_Table },
			{ text = "5, 6, 7, 8*", color = AMT.BackgroundClear_Table },
		},
		[2] = {
			{ text = "623", color = AMT.Uncommon_Color },
			{ text = "626", color = AMT.Uncommon_Color },
			{ text = "629", color = AMT.Uncommon_Color },
			{ text = "632", color = AMT.Uncommon_Color },
			{ text = "639", color = AMT.Uncommon_Color },
		},
		[3] = {
			{ text = "636", color = AMT.Rare_Color },
			{ text = "639", color = AMT.Rare_Color },
		...
		[4] = {
			...
			{ text = "655", color = AMT.Epic_Color },
			{ text = "658", color = AMT.Epic_Color },
			{ text = "665", color = AMT.Epic_Color },
		},
		[5] = {
			{ text = "662", color = AMT.Legendary_Color },
			{ text = "665", color = AMT.Legendary_Color },
			{ text = "668", color = AMT.Legendary_Color },
			{ text = "672", color = AMT.Legendary_Color },
			{ text = "678", color = AMT.Legendary_Color },
		},
	},
}
...
AMT.SeasonalInfo.UpgradeTrackTable = {
	...
	content = {
		[1] = {
			{ text = "623", color = AMT.BackgroundClear_Table },
			{ text = "626", color = AMT.BackgroundClear_Table },
			{ text = "629", color = AMT.BackgroundClear_Table },
			{ text = "632", color = AMT.BackgroundClear_Table },
			{ text = "636", color = AMT.BackgroundClear_Table },
			{ text = "639", color = AMT.BackgroundClear_Table },
			{ text = "642", color = AMT.BackgroundClear_Table },
			{ text = "645", color = AMT.BackgroundClear_Table },
			{ text = "649", color = AMT.BackgroundClear_Table },
			{ text = "652", color = AMT.BackgroundClear_Table },
			{ text = "655", color = AMT.BackgroundClear_Table },
			{ text = "658", color = AMT.BackgroundClear_Table },
			{ text = "662", color = AMT.BackgroundClear_Table },
			{ text = "665", color = AMT.BackgroundClear_Table },
			{ text = "668", color = AMT.BackgroundClear_Table },
			{ text = "672", color = AMT.BackgroundClear_Table },
